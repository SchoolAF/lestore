            ...
            <center>
                <div class="search-wrapper">
                    <form action="search.php" method="GET">
                        ...
                        <button type="submit" name="save" 1><span style="font-size: 18px; padding-top: 5px;" class="material-symbols-outlined">search</span></button>
                    </form>
                </div> 
            </center>
        </div>
        ...
        <section>
            <div class="search-banner">
                ...
                <?php 
                    ...
                    $data = mysqli_query($db_handler,"select * from le_product where product_category like '$category'");
